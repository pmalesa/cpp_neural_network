...
public:
    ...
    Matrix add_row(double val = 1.0, bool prepend = true) const;
    Matrix add_column(double val = 1.0, bool prepend = true) const;
    Matrix remove_row(bool beginning = true) const;
    Matrix remove_column(bool beginning = true) const;
