...
Logger::Logger(Level print_level) : print_level_(print_level) {
...
string Logger::construct_log_line_(Level level, string message) {
...
void Logger::append_log_file_(string log_line) {
...
string Logger::level_to_str_(Level level) {
